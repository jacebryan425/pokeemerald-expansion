...
const u8 gText_ThisIsAPokemon[] = _("This is one of the many Pokémon\nthat are found here.{PAUSE 96}\p");
...
const u8 gText_LanettesPC[] = _("Liam's PC");
